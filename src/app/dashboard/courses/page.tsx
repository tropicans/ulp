...
export default async function InstructorCoursesPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-100 dark:bg-slate-900 pt-24 pb-20">
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Kursus Saya</h1>
                        <p className="text-slate-500 dark:text-slate-400">Kelola kursus yang Anda instrukturi</p>
                    </div>
                ...
                {courses.length > 0 ? (
                    ...
                    <Card className="border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/30 border-dashed">
                        <CardContent className="flex flex-col items-center justify-center py-16">
                            ...
                            <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-2">Belum Ada Kursus</h3>
