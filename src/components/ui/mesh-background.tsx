    ...
    return (
        <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none transition-colors duration-500">
            ...
            <motion.div
                ...
                className="absolute -top-[10%] -left-[10%] w-[50%] h-[50%] bg-blue-400/5 dark:bg-blue-600/20 blur-[120px] rounded-full"
            />
            ...
            <motion.div
                ...
                className="absolute top-[20%] -right-[10%] w-[45%] h-[45%] bg-indigo-400/5 dark:bg-indigo-600/20 blur-[120px] rounded-full"
            />
            ...
            <motion.div
                ...
                className="absolute -bottom-[10%] left-[20%] w-[40%] h-[40%] bg-purple-400/5 dark:bg-purple-600/20 blur-[120px] rounded-full"
            />
